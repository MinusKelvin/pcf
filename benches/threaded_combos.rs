...
fn benchmark(c: &mut Criterion) {
    ...
    threaded.bench_function("1T", |b| rayon::ThreadPoolBuilder::new()
    ...
    threaded.bench_function("2T", |b| rayon::ThreadPoolBuilder::new()
    ...
    threaded.bench_function("4T", |b| rayon::ThreadPoolBuilder::new()
    ...
    threaded.bench_function("8T", |b| rayon::ThreadPoolBuilder::new()
        .num_threads(8).build().unwrap()
        .install(|| b.iter(||
            pcf::find_combinations_mt(
                black_box(PieceSet::default()
                    .with(I)
    ...
    threaded.bench_function("12T", |b| rayon::ThreadPoolBuilder::new()
        .num_threads(12).build().unwrap()
        .install(|| b.iter(||
            pcf::find_combinations_mt(
                black_box(PieceSet::default()
                    .with(I)
